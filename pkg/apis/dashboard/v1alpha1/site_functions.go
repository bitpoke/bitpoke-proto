...
// GetMemcachedSelector returns the memcached selector
func GetMemcachedSelector(wp *wordpressv1alpha1.Wordpress) labels.Set {
	memcachedSelector := GetSiteLabels(wp, "memcached")
	return memcachedSelector
}
