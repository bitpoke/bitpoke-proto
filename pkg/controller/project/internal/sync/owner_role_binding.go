...
func NewOwnerRoleBindingSyncer(proj *project.Project, cl client.Client, scheme *runtime.Scheme) syncer.Interface {
	obj := proj.ComponentObject(project.OwnerRoleBinding)

	return syncer.NewObjectSyncer("OwnerRoleBinding", proj.Unwrap(), obj, cl, scheme, func(existing runtime.Object) error {
		out := existing.(*rbacv1.RoleBinding)

		out.Labels = labels.Merge(labels.Merge(out.Labels, proj.Labels()), controllerLabels)
		out.Labels["presslabs.com/kind"] = "project-owner-list"
